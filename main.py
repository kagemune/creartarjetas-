...
# Determinar si la aplicación está ejecutándose como un ejecutable
...
class CardGeneratorApp(ctk.CTk):
    ...
    def generate_cards(self):
        try:
            # Obtener la ruta base correcta (importante para el ejecutable)
            ...
            template_path = resource_path('tarjetasEmpleados1.html')
